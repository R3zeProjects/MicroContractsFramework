...
$runtimeDependencyPattern =
    'Micro(?:Error|Persistence|Telemetry|Configuration|Resilience|Workflow|Service)Framework|vosp::(?:vosp|persistence|telemetry|configuration|resilience|workflow|service)'
