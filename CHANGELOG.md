...
- Добавлен gate экосистемы для Windows/Linux, который устанавливает все семь
  фреймворков как независимые пакеты CMake и проверяет отдельного downstream-потребителя.
...
- Consumer расширен контрактами версий, асинхронным drain, retry, отклонением
  persistence/configuration и сценарием дочернего процесса с ненулевым кодом.
