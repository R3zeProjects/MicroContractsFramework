...
It deliberately does not contain logging, persistence, threading, registries,
telemetry, I/O, or plugin implementations.
...
```cmake
find_package(vosp_contracts 0.1 REQUIRED CONFIG)
