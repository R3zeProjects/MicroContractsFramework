...
struct TelemetryRecord
{
    ...
    [[nodiscard]] std::chrono::system_clock::time_point timestamp() const noexcept { return {}; }
};
...
struct Snapshot
{
    ...
    [[nodiscard]] bool contains(std::string_view key) const noexcept { return key == "port"; }
};
...
struct Observer
{
    void configuration_changed(std::shared_ptr<const Snapshot> value)
    {
